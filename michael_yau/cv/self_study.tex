...
%---------------------------------------------------------
  ...
  {
    \begin{cvitems}
      \item {Created a playground library called Boxcat hosted on Pypl.}
...
{} % Dates (leave empty)
{
  \begin{cvitems}
    ...
    \item {Used to write my CV special thanks to Claud D. Park. for the base template modified to suit my taste and needs}
  \end{cvitems}
}
